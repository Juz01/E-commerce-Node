...
test("GET -> 'URL_BASE', should return status code 200 and res.body.legnth = 1", async () => {
...
test("GET ONE -> 'URL_BASE/:id', should return status code 200 and res.body.title = product.title", async () => {
...
test("DELET -> 'URL_BASE/:id', should return status code 204", async () => {
